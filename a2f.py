...
app.config['SECURITY_TWO_FACTOR_RESCUE_MAIL'] = "skycord.code@gmail.com"
...
app.config['SECURITY_TOTP_ISSUER'] = "app"
...
with app.app_context():
    ...
    db.create_all()
    if not app.security.datastore.find_user(email='chadimangle@pompiersparis.fr'):
        app.security.datastore.create_user(email='chadimangle@pompiersparis.fr', password='password')
    db.session.commit()
